...
<title>Daily Free Quiz – Global World Academy | MPTET Practice MCQs</title>
...
<meta property="og:title" content="Daily Free Quiz – Global World Academy | MPTET Practice MCQs"/>
<meta property="og:description" content="Practice free MPTET MCQs — Science, Child Development, General Knowledge & MP GK. Instant score & explanations."/>
...
<div class="top-banner">
  <div class="banner-inner">
    <div class="brand-row">
      ...
      <div class="brand-links">
        ...
        <a class="hdr-link link-yt"
           href="https://www.youtube.com/channel/UCAUjpk6WmdECWyGj90yl9Qg"
           target="_blank" rel="noopener">&#9654; YouTube</a>
        <a class="hdr-link link-course"
           href="https://classplusapp.com/w/global-world-academy-xygeb"
           target="_blank" rel="noopener">📚 Courses</a>
      </div>
    </div>
  ...
  <div class="topic-tabs" role="tablist" aria-label="Quiz topics">
    <button class="topic-tab active" onclick="loadQuiz('science',this)"  role="tab" aria-selected="true">🔬 Science</button>
    <button class="topic-tab" onclick="loadQuiz('child_dev',this)" role="tab" aria-selected="false">👶 Child Development</button>
    <button class="topic-tab" onclick="loadQuiz('gk',this)"        role="tab" aria-selected="false">🌍 General Knowledge</button>
    <button class="topic-tab" onclick="loadQuiz('mp',this)"        role="tab" aria-selected="false">🗺️ MP GK</button>
  </div>
...
<div class="quiz-page-main">
  ...
  <div class="quiz-stats-row">
    ...
    <div class="qs-card"><span class="qs-num">4</span><span class="qs-lbl">Topics</span></div>
  ...
  <div class="share-block" id="shareBlock" style="display:none;" aria-label="Share quiz results">
    ...
    <div class="share-btns">
      <a class="share-btn sb-wa" id="shareWa" href="#" target="_blank" rel="noopener">
        📱 Share on WhatsApp
      </a>
      <a class="share-btn sb-tg" id="shareTg" href="#" target="_blank" rel="noopener">
        ✈ Share on Telegram
      </a>
    </div>
  </div>
  ...
  <div class="info-cards">
    <div class="info-card">
      ...
      <div>
        <div class="ic-title">No Time Limit</div>
        <div class="ic-desc">Attempt at your own pace — take your time to think through each answer carefully.</div>
      </div>
    </div>
    <div class="info-card">
      <div class="ic-icon">💡</div>
      <div>
        <div class="ic-title">Explanations Included</div>
        <div class="ic-desc">Every question comes with a detailed explanation to reinforce your learning.</div>
      </div>
    </div>
    <div class="info-card">
      <div class="ic-icon">🔄</div>
      <div>
        <div class="ic-title">Multiple Topics</div>
        <div class="ic-desc">Switch between Science, Child Development, GK &amp; MP GK using the tabs above.</div>
      </div>
    </div>
    <div class="info-card">
      <div class="ic-icon">📊</div>
      <div>
        <div class="ic-title">Instant Score</div>
        <div class="ic-desc">Get your score immediately after completing all 10 questions with a performance message.</div>
      </div>
    </div>
  </div>
  ...
  <div class="page-footer">
    <div class="footer-brand-name">Global World Academy</div>
    <div class="footer-links">
      <a href="{{ url('/') }}">&larr; Back to Home</a>
      <a href="https://www.youtube.com/channel/UCAUjpk6WmdECWyGj90yl9Qg" target="_blank" rel="noopener">&#9654; YouTube Channel</a>
      <a href="https://classplusapp.com/w/global-world-academy-xygeb" target="_blank" rel="noopener">📦 All Courses</a>
      <a href="tel:+918770803840">📞 +91-8770803840</a>
    </div>
    <div class="footer-note">
      MPTET Varg 2 &amp; Varg 3 Expert Coaching &middot; Free Daily Quizzes &middot;
      &copy; {{ date('Y') }} Global World Academy
    </div>
  </div>
