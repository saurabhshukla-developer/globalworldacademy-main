...
return [
    ...
    'materials_empty' => 'No materials available yet.',
    'materials_view_all' => 'Browse all materials by subject →',
    'study_materials_title' => 'Study Materials',
    'study_materials_meta_description' => 'Browse free notes and practice papers by quiz subject and topic — Global World Academy MPTET resources.',
    'study_materials_intro' => 'Downloads open in a new tab when you use an external link (Drive, etc.). Materials are grouped under the same subjects and topics as the quiz.',
    'study_materials_uncategorized' => 'General resources',
    'study_materials_back_home' => 'Back to home',
    ...
    'footer_study_materials' => 'All study materials (by topic)',
    'footer_study_home_preview' => 'Featured on homepage',
